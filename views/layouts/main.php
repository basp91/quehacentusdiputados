...
<head>
    ...
    <?= Html::csrfMetaTags() ?>
    <title>Yo en la cámara de diputados</title>
    <?php $this->head() ?>
</head>
<body>
<?php $this->beginBody() ?>
...
<footer class="footer">
    <div class="container">
        <p class="pull-left">SpaceshipLabs - Civil Hack 2015</p>

        <p class="pull-right">Desarrollada por: Izeth López, Beatriz Sánchez, Irving Martín</p>
    </div>
</footer>
